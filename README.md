...
```
python -m swarm_rl.enjoy --algo=APPO --env=quadrotor_multi --replay_buffer_sample_prob=0 --quads_use_numba=False --quads_render=True --train_dir=train_dir --experiment=EXPERIMENT_NAME --quads_view_mode CAMERA_VIEWS
```
