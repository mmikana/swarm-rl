"""
PPO baseline with Euclidean reward only.

Usage:
    python -m sample_factory.launcher.run --run=swarm_rl.runs.adaptive_skill.quads_guidance_none
"""
