QUAD_BASELINE_CLI_8 = (
    ...
    # Quad specific
    '--quads_use_numba=True --save_milestones_sec=3600 --anneal_collision_steps=30000000 '
    ...
    # Neighbor
    '--quads_neighbor_hidden_size=256 --quads_neighbor_obs_type=none --quads_collision_hitbox_radius=0.5 '
    ...
    # Obstacles
    '--quads_use_obstacles=True --quads_obst_spawn_area 8 8 --quads_obst_density=0.1 --quads_obst_size=0.6 '
